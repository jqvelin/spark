...
export const Sidebar = () => {
    ...
    return (
        <aside className="hidden h-[calc(100vh-var(--header-height))] justify-center items-start gap-4 border-2 border-y-0 border-l-0 border-r-primary/20 px-2 py-2 transition-all hover:border-r-primary/30 md:inline-flex md:px-4">
